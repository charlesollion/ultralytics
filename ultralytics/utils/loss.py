...
class v8DetectionLoss:
    ...
    def __init__(
        self, model: torch.nn.Module, tal_topk: int = 10, tal_topk2: int | None = None, class_weights=None
...
class E2EDetectLoss:
    ...
    def __init__(self, model: torch.nn.Module, class_weights=None):
...
class E2ELoss:
    ...
    def __init__(self, model: torch.nn.Module, loss_fn=v8DetectionLoss, class_weights=None):
