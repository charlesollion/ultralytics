...
class Detect(nn.Module):
    ...
    def __init__(self, nc: int = 80, c2 = None, c3 = None, arch="standard", ch: tuple = ()):
        """
...
class Segment(Detect):
    ...
    """
    def __init__(self, nc: int = 80, nm: int = 32, npr: int = 256, c2 = None, c3 = None, arch = "standard", ch : tuple = ()):
